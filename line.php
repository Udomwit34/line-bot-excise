...
$ACCESS_TOKEN = 'Tycjg+7yngdlHmjDoh/5lmtd8dmT2S6MBac8hrB1Fo0FW1ZrxigLiNegpyny6ZgbSaKpRFGKPWFUrCtuKfZ2vgaHFPx5CZqgHnuy0Iwd9BpUCyFR24Wf2kdExXlnGg08yAdmdaha+JOqWS1nMCvxvAdB04t89/1O/w1cDnyilFU='; // Access Token ค่าที่เราสร้างขึ้น
  ...
  if ( $event['type'] == 'message' ) 
  {
   ...
   if( $event['message']['type'] == 'text' )
   {
	   ...
	   if($text == "ใบอนุญาตขายสุราของฉันหมดอายุวันไหน"){
	    ...
	    if($text == "อุณหภูมิตอนนี้" || $text == "อุณหภูมิขณะนี้ || $text == "อุณหภูมิเท่าไหร่"){
